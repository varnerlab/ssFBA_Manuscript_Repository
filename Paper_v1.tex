...
The theoretical maximum mean productivity was inversely proportional to the protein size and varied between 1 and 12 $\mu$M/h for the proteins sampled (Fig.~\ref{fig:Prof}A-B). The theoretical maximum productivity was within a standard deviation with and without
amino acid supplementation for each protein, but varied significantly between proteins.
This suggested the cell free reaction had sufficient metabolic precursors to power CFPS and synthesize each protein of interest with similar productivities.
However, the theoretical productivity was inversely proportional to protein size;
for instance, BMP10 (XX aa) had a productivity of about 2.5 $\mu$M/h whereas CAT (ZZ aa) had a productivity of about 12 $\mu$M/h.
To examine this further, the mean productivity was plotted against the carbon number of each protein (Fig.~\ref{fig:Prof}B).
The productivity and protein size were related by the power-law relationship $\alpha\times(L)^{\beta}$, where $\alpha = 6.0\times 10^{6}$ and $\beta=-1.9$.
Interestingly, CAT did not obey the trendline; the relatively high productivity of CAT was due to its T7 promoter.
CAT expressed under a P70a promoter followed the power-law correlation with a productivity of approximately 8.8 $\mu$M/h.
Taken together, the maximum productivity of a cell free reaction was found to be inversely proportional to protein size,
