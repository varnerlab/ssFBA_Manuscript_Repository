...
The prediction error was less than 8\% for an \emph{a~priori} prediction of CFPS productivity.
...
The experimentally constrained energy efficiency was 13.3 $\pm$ 5.0\% compared to the theoretical maximum of approximately 84 $\pm$ 0.1\%, however, the
CAT productivity was similar between the simulated and measured systems.
This suggested CFPS was not energy optimized.
There were two factors responsible for the difference between the optimal and experimental system,
the glucose consumption rate and the ATP yield per glucose.
The glucose consumption rate was approximately 30 mM/h in the experimental system (even in the presence of amino acids).
However, the constraint based simulation suggested the optimal glucose consumption rate was significantly less than the observed rate, approximately 2 - 4 mM/h.
In the constraint based simulation, the CFPS reaction produced only acetate as a by-product, but in the experimental system acetate, lactate, pyruvate, succinate and malate accumulated during the first hour of production.
...
The MBP prediction also showed good agreement with the constraint based model, with an error between 3\% to 4\% with and without amino acid supplementation.
...
In the absence of amino acids, glucose consumption increased, with the change in the carbon yield being largely accounted for by increased CO\textsubscript{2} production.
