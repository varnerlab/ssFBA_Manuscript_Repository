...
The protein synthesis reaction was conducted according to the PANOxSP protocol with slight modifications from that described previously \cite{BIT:BIT20026}.
...
The transcription (T) and translation (X) stoichiometry was modeled based on the template reactions of Allen and Palsson \cite{Allen:2003aa}:
