...
A schematic of the metabolic network, which consisted of 270 reactions and 145 species, is shown in Fig.~\ref{fig:network}A.
...
The difference in the T7 and  P70a promoters did not alter the qualitative productivity performance of CAT.
...
The energy efficiency of protein production remained relatively high for when amino acids were supplied in the media, however energy efficiency dropped below 30\% when amino acids were not available (Fig.~\ref{fig:Energy}).
...
When amino acids were removed from the media, protein production resulted in a low energy efficiency; below 30\% depending on the protein. 
This was because glucose had to be utilized to synthesize the amino acids necessary for protein synthesis, in addition to being available for energy generation.
...
Interestingly, without supplemented amino acids (third case) each protein had a similar energy efficiency of about 25\% regardless of carbon number.
...
However, the experimentally constrained case of CAT production showed even a lower energy efficiency of 3.3 $\pm$ 1.4\% compared to the theoretical maximum of 72 $\pm$ 7.1\%.
...
In addition, ssFBA is solved by setting protein production as the objective function to maximize.
...
A single trendline was formulated for the cases where amino acids were supplied in the media (first two cases) since they had similar performance, while another trendline was formulated for when amino acids were not available (available in Supporting Information).
...
On the other hand, amino acid uptake showed significance for the cases where amino acids were available, and was even higher for the second case (without AA synthesis), as it was the only source of amino acids.
\begin{figure}[t!]
...
Oxygen uptake showed significant importance for energy efficiency, since it was responsible for oxidative phosphorylation, the most efficient pathway for energy generation.
Meanwhile, productivity was determined primarily by the rate of the most downstream steps, transcription and translation.
Across all three cases, substrate utilization (amino acid uptake and glucose) was shown to be the next most important as these substrates contributed to the energy efficiency and carbon yield of deGFP.
In the first two cases where amino acids were supplied, amino acid uptake was significant, as without it, energy was required to synthesize amino acids for the protein of interest.
Glucose uptake was only seen to be significant when amino acids were not available in the media (third case), since it was the only source of carbon for protein synthesis and energy generation.
...
The first two cases where amino acids are supplied followed the same trend: ranging from a carbon yield of 20\% to 55\%, depending on the oxidative phosphorylation activity.
Once amino acids were removed from the media the carbon yield dropped to about 10\%, but still reached the same maximum of 55\% with higher oxidative phosphorylation flux.
When amino acids are not avialable in the media, a lower carbon yield was expected for the same oxidative phosphorylation flux, since carbon must be utilized for energy generation and amino acid synthesis.
...
To investigate the differences between the three cases, we compared the flux distributions for a representative protein, deGFP, predicted by ssFBA simulations (Fig.~\ref{fig:flux}).
\begin{figure}[t!]
...
In the third case, where amino acids must be synthesized, there is drop in the performance metrics of energy efficiency and carbon yield compared to the cases where amino acids are avialble.
The flux distribution had a correlation fo 0.95 when compared to both cases where amino acids were avaialbe. 
...
The fourth case, constrained by experimental measurements (Fig. \ref{fig:flux_exp}), had the highest correlation of 0.66 with the flux distribution from the case supplied with no amino acids and a correlation of 0.6 with the cases supplied with amino acids.
This shows the case constrained by experimental measurements has some differences in the flux distribution compared to the optimum solutions which may provide some insight to improve CFPS performance. 
